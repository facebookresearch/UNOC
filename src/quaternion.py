...
# def qmul_np(q, r):
#     _q = torch.from_numpy(q).contiguous().float()
#     _r = torch.from_numpy(r).contiguous().float()
#     return qmul(_q, _r).numpy()
...
# def qrot_np(q, v):
#     _q = torch.from_numpy(q).contiguous().float()
#     _v = torch.from_numpy(v).contiguous().float()
#     result = qrot(_q, _v).numpy()
#     return result
